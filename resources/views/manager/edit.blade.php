...
@section('content')
    <div class="container mx-auto">
        <x-edit-profile>
            ...
            <x-slot name="form">
                <form method="POST"
                      action="{{ route('manager.update', $manager) }}">
                    @csrf
                    @method('PUT')
                    <div class="mb-6 flex flex-wrap justify-between">
                        <div class="w-1/2 pr-3">
                            ...
                            <x-input name="nome" type="text" id="nome" value="{{$manager->nome}}"
                        ...
                        <div class="w-1/2">
                            ...
                            <x-input name="cognome" type="text" id="cognome" value="{{$manager->cognome}}"
                    ...
                    <div class="mb-6 flex flex-wrap justify-between">
                        <div class="w-full">
                            ...
                            <x-input name="email" type="email" id="email" value="{{$manager->email}}"
