        ...
        <div class="card">
            <div class="card-body">
                <div class="form-container">
                    <form method="POST" action="{{ route('pagina-personale.update-info', $user) }}">
                        @csrf
                        @method('PUT')
                        <div class="mb-6">
                            <div class="form-control float-left inline-block">
                                ...
                                <input name="nome" type="text" id="nome" value="{{$user->nome}}"
                            ...
                            <div class="form-control float-right inline-block">
                                ...
                                <input name="cognome" type="text" id="cognome" value="{{$user->cognome}}"
                        ...
                        <div class="mb-6">
                            ...
                            <div class="form-control float-right inline-block">
                                <label for="data_nascita"
                                       class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Data di
                                    nascita</label>
                                <input datepicker name="data_nascita" type="text" id="data_nascita" value="{{$user->data_nascita.date('d/m/Y')}}"
                                       required
                        ...
                        <div class="mb-6">
                            <div class="form-control float-left inline-block">
                                ...
                                <input name="universita" type="text" id="università" value="{{$user->universita}}"
                                       class="@error('universita') is-invalid @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            </div>
                            <div class="form-control float-right inline-block">
                                <label for="ambito_ricerca"
                                       class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ambito di
                                    ricerca</label>
                                <input name="ambito_ricerca" type="text" id="ambito_ricerca"
                                       value="{{$user->ambito_ricerca}}"
                        ...
                        <div class="mb-6">
                            ...
                            <input name="nome_azienda" type="text" id="nome_azienda" value="{{$user->nome_azienda}}"
