            ...
            <div class="justify-center row">
                <div class="w-full lg:w-5/6 xl:w-2/3">
                    <div class="pt-5 pb-64 header-content"> <!-- pt padding top -->
                        ...
                        <form class="" id="creazioneP" method="POST" action="{{ route('progetto.store') }}">
                            @csrf
                            @method('POST')
                            <div class="mb-6">
                                <div class="flex justify-around">
                                    <div class="inline-block">
                                        ...
                                        <x-input name="titolo" type="text" value="{{ old('titolo') }}" id="titolo" placeholder="Nome del progetto"></x-input>
                                    </div>
                                    <div class="inline-block">
                                        <label for="scopo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 flex justify-center">Scopo:</label>
                                        <x-input name="scopo" type="text" value="{{ old('scopo') }}" id="scopo" placeholder="Scopo del progetto"> </x-input>
                                    </div>
                                    <div class="inline-block">
                                ...
                                <div class="ml-28 mr-28">
                                    <div class="mt-7" >
                                        ...
                                        <x-input name="descrizione" type="text" value="{{ old('descrizione') }}" id="descrizione" placeholder="Descrizione del progetto"> </x-input>
                                    </div>
                                </div>
                        ...
                        <div class="mt-4 ml-64 form-control inline-block">
                            ...
                            <select name="responsabile_id" form="creazioneP">
